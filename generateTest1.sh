...
Brckt.c          FloatUnary.c     IfArith.c              IfUnary.c             NestedLoop.c        RelInStmt.c      UnaryPlus.c \
Const.c          Glob.c           IfFloatArith.c         InfiniteLoop.c        NoDeclNoDef1BB.c    RetInFor.c       UserIfTmp.c \
...
do
	...
	# ./cfglp -tokens  $FOLDER/$f"s306.cfg" -d >> out1
	# ./cfglp64 -tokens $FOLDER/$f"s306.cfg"  -d>> out2
done
